...
namespace LinkHarvester.Persistence.Migrations
{
    ...
    [Migration("20260530131234_AddCatalogCardLinkFacetsAudioLangsIndex")]
    partial class AddCatalogCardLinkFacetsAudioLangsIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinkHarvester.Persistence.AppSettingsEntity", b =>
                {
                    ...
                    b.Property<long?>("CardsBackfilledAt")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LinkHarvester.Persistence.Cards.CatalogCardEntity", b =>
                {
                    b.Property<int>("TitleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("SeasonMax")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("SeasonMin")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("HasMetadata");

                    b.HasIndex("OriginalLanguage");

                    b.HasIndex("IsHidden", "NormalizedTitle");

                    b.HasIndex("IsHidden", "Popularity");

                    b.HasIndex("IsHidden", "Rating");

                    b.HasIndex("IsHidden", "Year");

                    b.ToTable("CatalogCards");
                });

            modelBuilder.Entity("LinkHarvester.Persistence.Cards.CatalogCardGenreEntity", b =>
                {
                    ...
                    b.HasKey("CardId", "Genre");

                    b.HasIndex("Genre", "CardId");

                    b.ToTable("CatalogCardGenres");
                });

            modelBuilder.Entity("LinkHarvester.Persistence.Cards.CatalogCardLinkFacetEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("AudioLangs", "CardId");

                    b.HasIndex("NormalizedHost", "CardId");

                    b.HasIndex("QualityName", "CardId");

                    b.HasIndex("CardId", "NormalizedHost", "QualityName");

                    b.ToTable("CatalogCardLinkFacets");
                });

            modelBuilder.Entity("LinkHarvester.Persistence.Cards.InboxCardEntity", b =>
                {
                    b.Property<int>("TitleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<bool>("BetterAvailable")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("CatalogTitleId")
                        .HasColumnType("INTEGER");

                    b.Property<string>("ChosenArticleJson")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("OtherVariantsJson")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("Visible", "UpdatedAt");

                    b.ToTable("InboxCards");
                });
