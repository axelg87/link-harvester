...
public static class SourcesServiceCollectionExtensions
{
    public static IServiceCollection AddHarvesterSources(this IServiceCollection services)
    {
        ...
        services.AddSingleton<ZtListingParser>();
        ...
        services.AddSingleton<ZtFeedSource>();
        services.AddSingleton<IFeedSource>(sp => sp.GetRequiredService<ZtFeedSource>());
        services.AddSingleton<IBackfillFeedSource>(sp => sp.GetRequiredService<ZtFeedSource>());
        return services;
    }
}
